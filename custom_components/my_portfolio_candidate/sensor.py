"""Sensor-Platform für My Portfolio Candidate – aktueller Kurs."""
...
class KandidatKursSensor(CoordinatorEntity[MyPortfolioCandidateCoordinator], SensorEntity):
    """Aktueller Kurs eines My Portfolio Candidate."""
